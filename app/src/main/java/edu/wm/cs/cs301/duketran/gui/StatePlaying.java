...
public class StatePlaying extends DefaultState {
     ...
     * @param playActivity provides access to the activity this state resides in
    ...
    public void start(PlayActivity playActivity, MazePanel panel) {
        ...
        cr.setPositionAndSize(Constants.VIEW_WIDTH/2,
        		(int)(0.125*Constants.VIEW_HEIGHT),145);
     ...
     * Method requires {@link #start(PlayActivity, MazePanel) start} to be
     * called before.
