...
public class Floorplan {
	...
	public boolean canTearDown(Wallboard wallboard) {
		...
		int[] d = wallboard.getDirection().getDirection() ;
		int dx = d[0];
		int dy = d[1];
	...
	/**
	 * checks if the given wallboard contributes to a border.
	 * One can think of exterior walls of the maze and its 
	 * rooms as essential for the structure and their wallboards
