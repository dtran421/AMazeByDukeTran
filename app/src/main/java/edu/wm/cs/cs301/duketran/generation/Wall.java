...
import edu.wm.cs.cs301.duketran.gui.MazeFileWriter;
import edu.wm.cs.cs301.duketran.gui.P5Panel;
...
public class Wall {
     ...
     */
    public Wall[] calculatePartitioning(Wall splitter, int colchange) {
